...
_KEYVALUE = _descriptor.Descriptor(
  name='KeyValue',
  full_name='blueapi.api.KeyValue',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='blueapi.api.KeyValue.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='blueapi.api.KeyValue.value', index=1,
