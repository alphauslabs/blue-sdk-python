...
_ADMIN = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002#\022!/admin/v1/aws/crossacctaccess/cfn',
    create_key=_descriptor._internal_create_key,
  ),
])
