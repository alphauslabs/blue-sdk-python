...
class FlowStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCrossAccountAccessDetails = channel.unary_unary(
                ...
                _registered_method=True)
        self.CreateMessageToSlack = channel.unary_unary(
...
class FlowServicer(object):
    ...
    def CreateMessageToSlack(self, request, context):
...
def add_FlowServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreateMessageToSlack': grpc.unary_unary_rpc_method_handler(
...
class Flow(object):
    ...
    @staticmethod
    def CreateMessageToSlack(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
