...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_COST']._serialized_end=585
  _globals['_COSTATTRIBUTE']._serialized_start=588
  _globals['_COSTATTRIBUTE']._serialized_end=818
