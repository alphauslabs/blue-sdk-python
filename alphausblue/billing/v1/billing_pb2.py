...
_LISTUSAGECOSTSDRIFTREQUEST = _descriptor.Descriptor(
  name='ListUsageCostsDriftRequest',
  full_name='blueapi.billing.v1.ListUsageCostsDriftRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='vendor', full_name='blueapi.billing.v1.ListUsageCostsDriftRequest.vendor', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='billingInternalId', full_name='blueapi.billing.v1.ListUsageCostsDriftRequest.billingInternalId', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='month', full_name='blueapi.billing.v1.ListUsageCostsDriftRequest.month', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_USAGECOSTSDRIFT = _descriptor.Descriptor(
  name='UsageCostsDrift',
  full_name='blueapi.billing.v1.UsageCostsDrift',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='billingInternalId', full_name='blueapi.billing.v1.UsageCostsDrift.billingInternalId', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='billingGroupId', full_name='blueapi.billing.v1.UsageCostsDrift.billingGroupId', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='snapshot', full_name='blueapi.billing.v1.UsageCostsDrift.snapshot', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='current', full_name='blueapi.billing.v1.UsageCostsDrift.current', index=3,
      number=4, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ListUsageCostsDriftRequest'] = _LISTUSAGECOSTSDRIFTREQUEST
DESCRIPTOR.message_types_by_name['UsageCostsDrift'] = _USAGECOSTSDRIFT
...
_BILLING = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ListUsageCostsDrift',
    full_name='blueapi.billing.v1.Billing.ListUsageCostsDrift',
    index=5,
    containing_service=None,
    input_type=_LISTUSAGECOSTSDRIFTREQUEST,
    output_type=_USAGECOSTSDRIFT,
    serialized_options=b'\202\323\344\223\0024\"//v1/{vendor}/billinggroups/usagecostsdrift:read:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
